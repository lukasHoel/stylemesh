...
glm::mat4 perspective(glm::mat3& intrinsics, int width, int height, double n, double f) {
    ...
    // glm::mat4 res2(2 * intrinsics[0][0] / width, 0, 0, 0,
    //                0, 2 * intrinsics[1][1] / height, 0, 0,
    //                0, 0,  f/(f-n), f*n/(n-f),
    //                0, 0, 1, 0);
    ...
    // res2 = glm::transpose(res2); // I have written it in row major but glm uses column major... I hate this stuff.
