...
public:
    ...
    void savePose(std::string filename, const glm::mat4& view);
    void saveIntrinsics(std::string filename, const glm::mat3& intr, int width, int height);
    ...
    static const int copy_color = 6;
    static const int copy_depth = 7;
protected:
